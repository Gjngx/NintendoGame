...
import com.example.nintendogame.daos.Cart;
...
import com.example.nintendogame.reponsitory.IInvoiceRepository;
import com.example.nintendogame.reponsitory.IItemInvoiceRepository;
...
public class CartService {
    ...
    public void saveCart(@NotNull HttpSession session) {
        ...
        cart.getCartItems().forEach(item -> {
            ...
            items.setSanPham(sanPhamReponsitory.findById(item.getNtdId()).orElseThrow());
